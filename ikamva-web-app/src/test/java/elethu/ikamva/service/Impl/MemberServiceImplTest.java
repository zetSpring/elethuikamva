...
class MemberServiceImplTest {
    ...
    void saveNewMemberWithContactDetailsTest() {
        ...
        Member member = new Member(
                1L,
                Long.parseLong("1006145427081"),
                "EY012015",
                "Emihle",
                "Yawa",
                DateFormatter.returnLocalDate("2008-04-26"),
                Gender.FEMALE);
        List<ContactDetails> memberContacts = new ArrayList<>();
        memberContacts.add(new ContactDetails(
                1L, "0712345678", ContactType.CELLPHONE, "EY012015", DateFormatter.returnLocalDate("2008-04-26")));
        memberContacts.add(new ContactDetails(
                2L,
                "emihle.yawa@ikamva.com",
                ContactType.EMAIL,
                "EY012015",
                DateFormatter.returnLocalDate("2008-04-26")));
        member.setMemberContacts(memberContacts);
        when(corpCompanyRepository.findCorpCompany())
                .thenReturn(Optional.of(new CorpCompany(
                        1L, "12345", "Elethu Ikamva", "2022-01-01", DateFormatter.returnLocalDateTime())));
    ...
    void saveExistingMemberWithContactsTest() {
        ...
        existingMemberContacts.add(new ContactDetails(
                1L, "0712345678", ContactType.CELLPHONE, "EY012015", DateFormatter.returnLocalDate("2008-04-26")));
        existingMemberContacts.add(new ContactDetails(
                2L,
                "emihle.yawa@ikamva.com",
        ...
        // when(memberRepository.fid(anyLong())).thenReturn(Optional.of(existingMember));
        when(corpCompanyRepository.findCorpCompany())
                .thenReturn(Optional.of(new CorpCompany(
                        1L, "12345", "Elethu Ikamva", "2022-01-01", DateFormatter.returnLocalDateTime())));
        when(memberRepository.save(any())).thenReturn(member);
    ...
    void saveAllMembers() {
        ...
        List<ContactDetails> memberContacts = new ArrayList<>();
        memberContacts.add(new ContactDetails(
                1L, "0712345678", ContactType.CELLPHONE, "TM012015", DateFormatter.returnLocalDate("2008-04-26")));
        memberContacts.add(new ContactDetails(
                1L,
                "thabo.mbeki@ikamva.com",
                ContactType.EMAIL,
                "TM012015",
                DateFormatter.returnLocalDate("2008-04-26")));
        member.setMemberContacts(memberContacts);
        ...
        Member member1 = new Member(
                2L,
                Long.parseLong("85072354207081"),
                "NN012015",
                "Nomvula",
                "Nonkonyane",
                DateFormatter.returnLocalDate("2021-04-26"),
                Gender.FEMALE);
        List<ContactDetails> member1Contacts = new ArrayList<>();
        member1Contacts.add(new ContactDetails(
                1L, "07287654321", ContactType.CELLPHONE, "NN012015", DateFormatter.returnLocalDate("2021-04-26")));
        member1Contacts.add(new ContactDetails(
                1L,
                "nomvula.nonkonyane@ikamva.com",
                ContactType.EMAIL,
                "TM012015",
                DateFormatter.returnLocalDate("2008-04-26")));
        ...
        CorpCompany corpCompany =
                new CorpCompany(1L, "12345", "Ikamva", "2022-01-01", DateFormatter.returnLocalDateTime());
    ...
    void findAllMembers() {
        ...
        Member member1 = new Member(
                2L,
                Long.parseLong("8507224992080"),
                "ZY012015",
                "Zuko",
                "Yawa",
                DateFormatter.returnLocalDate("2022-01-11"),
                Gender.MALE);
        List<Member> members = new ArrayList<>();
        members.add(member);
        members.add(member1);
